  ...
  return (
    <nav className="flex items-center justify-center gap-x-6 rounded-lg bg-[#eaf6ff] p-2.5">
      <a href="/" className="no-underline">
        <span
          className={`${leagueSpartan.className} font-heading text-body text-ink-900 hover:underline`}
        >
          Home
        </span>
      </a>
      {breadcrumbItems.map((item, index) => (
        <div
          key={index}
          className="flex cursor-pointer items-center justify-center gap-x-4 text-ink-900"
        >
