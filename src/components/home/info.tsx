...
const Info = () => {
  ...
  return (
    <div className="relative mt-[2.5vh] flex h-60 w-full items-end justify-between sm:mt-[2vh] sm:h-96 md:mt-[1.5vh] md:h-[70vh] lg:mt-[1vh] lg:h-[80vh]">
      <div className="relative ms-[2%] mb-[5vh] flex h-[12vh] w-[35vw] flex-col items-center justify-center rounded-[1vh] bg-white shadow-[0px_0px_30px_0px_#38B6FF33] animate-[bounce_5s_ease-in-out_infinite] sm:mb-[10vh] sm:h-[15vh] sm:w-[23vw] md:mb-[15vh] md:h-[18vh] md:w-[25vw] lg:mb-[20vh] lg:h-[20vh] lg:w-[16vw]">
      ...
      <div className="me-[2%] mb-[5vh] mt-[1vh] flex w-[30vw] flex-col items-center justify-center gap-[1vh] rounded-[1vh] animate-[bounce_6s_ease-in-out_infinite] sm:mb-[10vh] sm:w-[25vw] md:mb-[15vh] md:w-[20vw] lg:mb-[20vh] lg:w-[15vw]">
