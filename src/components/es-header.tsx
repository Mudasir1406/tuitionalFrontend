...
const EsHeader: React.FC<IProps> = ({ background }) => {
      ...
      <AppBar position="sticky" sx={styles.container}>
        ...
        <Toolbar sx={styles.toolBar}>
          ...
          <Box sx={styles.navSection}>
            ...
            <a href={"/es/about"} style={styles.link}>
              <Typography
                sx={styles.typography}
                className={leagueSpartan.className}
              >
            ...
            <a href={"/es/testimonials"} style={styles.link}>
              <Typography
                sx={styles.typography}
                className={leagueSpartan.className}
              >
            ...
            <a href={"/es/contact"} style={styles.link}>
              <Typography
                sx={styles.typography}
                className={leagueSpartan.className}
              >
