...
| B4 | 141 | `grid grid-cols-1 lg:grid-cols-2 gap-x-4 gap-y-2` | MUI form is always 2-col flex with `column-gap:24px` regardless of breakpoint, and Subject row spans full-width. Port collapses to 1 col on mobile + small/medium. | **High** — mobile layout differs |
